...
| CN1…CN5 | 5 | Connettore A2502-WV02 (+5V/GND) | CN5 = ingresso 5 V; CN1…CN4 = ventole |
...
| 4 | Ventola 40×40×10 mm (4010) 5 V | Temu | ~0,1–0,2 A ciascuna (verifica l'etichetta); sui connettori CN1…CN4, sempre accese |
...
| 5 V: ESP32 ~0,25 A + servo gripper (stallo fino a ~2,5 A) + 4 ventole 4010 (~0,4–0,8 A) | ~3,5 A di picco → 70 % dello step-down (5 A) ✓; a regime ~1 A |
